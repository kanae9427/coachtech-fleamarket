...
<div class="shipping_address-container">
    ...
    <form action="{{ route('address.update', $item->id) }}" method="post" class="shipping_address-form">
        ...
        <div class="shipping_address-box">
            <!-- 郵便番号 -->
            <div class="shipping_address-form-group">
                <label class="shipping_address-label" for=" shipping_postal_code">郵便番号</label>
            ...
            <!-- 住所 -->
            <div class="shipping_address-form-group">
                <label class="shipping_address-label" for="shipping_address">住所</label>
            ...
            <!-- 建物名 -->
            <div class="shipping_address-form-group">
                <label class="shipping_address-label" for="shipping_building_name">建物名</label>
